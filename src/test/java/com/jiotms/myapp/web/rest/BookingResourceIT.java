...
import com.jiotms.myapp.repository.BookingRepository;
import com.jiotms.myapp.repository.search.BookingSearchRepository;
import com.jiotms.myapp.service.BookingService;
...
import static com.jiotms.myapp.web.rest.TestUtil.createFormattingConversionService;
...
import com.jiotms.myapp.domain.enumeration.StatusEnum;
/**
...
public class BookingResourceIT {
     ...
     *
     * @see com.jiotms.myapp.repository.search.BookingSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void getAllBookings() throws Exception {
        ...
        restBookingMockMvc.perform(get("/api/bookings?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].loadNuber").value(hasItem(DEFAULT_LOAD_NUBER.toString())))
    ...
    public void getBooking() throws Exception {
        ...
        restBookingMockMvc.perform(get("/api/bookings/{id}", booking.getId()))
            ...
            .andExpect(jsonPath("$.loadNuber").value(DEFAULT_LOAD_NUBER.toString()))
