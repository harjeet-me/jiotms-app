...
import com.jiotms.myapp.domain.enumeration.DesignationEnum;
/**
...
public class ContactResourceIT {
    ...
    private static final DesignationEnum DEFAULT_DESIGNATION = DesignationEnum.MANAGER;
    private static final DesignationEnum UPDATED_DESIGNATION = DesignationEnum.ACCOUNTANT;
     ...
     *
     * @see com.jiotms.myapp.repository.search.ContactSearchRepositoryMockConfiguration
     */
    @Autowired
