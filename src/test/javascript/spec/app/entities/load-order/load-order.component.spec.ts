...
import { LoadOrderComponent } from 'app/entities/load-order/load-order.component';
...
describe('Component Tests', () => {
  describe('LoadOrder Management Component', () => {
    let comp: LoadOrderComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(LoadOrderComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.loadOrders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
