...
import { LoadOrderDeletePopupComponent } from './load-order-delete-dialog.component';
...
export const loadOrderRoute: Routes = [
  {
    ...
    data: {
      ...
      defaultSort: 'id,asc',
      pageTitle: 'jiotmsApp.loadOrder.home.title'
    },
...
export const loadOrderPopupRoute: Routes = [
  {
    path: ':id/delete',
    component: LoadOrderDeletePopupComponent,
    resolve: {
      loadOrder: LoadOrderResolve
    },
    data: {
